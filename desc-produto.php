  ...
  <div class="page-wrapper">
    ...
    <section class="produto_single_one">
      <div class="container z-2">
        <div class="row">
          <div class="col-xl-6 col-lg-6 col-md-12 produto_single_col">
            <h1>
            ...
            <div class="produto_single_one_link">
              <a href="<?php echo $produto->section_2_link_conteudo_8 ?>"
                aria-label="<?php echo $produto->section_2_link_alt_8 ?>">
                <?php echo $produto->section_2_link_8 ?>
              </a>
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-12">
            <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_2_img_9 ?>"
              alt="<?php echo $produto->section_2_image_alt_9 ?>" class="w-100">
          </div>
        </div>
      </div>
      <div class="shape_produto">
        <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_2_img_10 ?>"
          alt="<?php echo $produto->section_2_image_alt_10 ?>">
      </div>
    </section>
        ...
        <div class="home_four_content_icons">
          <div class="row home_four_content_icons_section">
            <div class="col-xl-4 col-lg-4 col-md-12">
              <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_3_img_11 ?>"
                alt="<?php echo $produto->section_3_image_alt_11 ?>">
              <p>
                <?php echo $produto->section_3_conteudo_12 ?>
              </p>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12">
              <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_3_img_13 ?>"
                alt="<?php echo $produto->section_3_image_alt_13 ?>">
              <p>
                <?php echo $produto->section_3_conteudo_14 ?>
              </p>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-12">
              <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_3_img_15 ?>"
                alt="<?php echo $produto->section_3_image_alt_15 ?>">
              <p>
    ...
    <section class="video-two">
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-6 col-md-12 video-two_content">
            <span>
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 position-relative">
            ...
            <?php if($produto->section_4_link_20) : ?>
                <div class="video_two_link">
                  <a href="<?php echo $produto->section_4_link_20 ?>"
      ...
      <div class="container">
        <div class="row home_six_content">
          <div class="col-xl-6 col-lg-6 col-md-12 d-flex justify-content-center z-2">
            <div class="home_six_text">
              ...
              <div class="home_six_link">
                <a href="<?php echo $produto->section_5_link_conteudo_22 ?>"
                  aria-label="<?php echo $produto->section_5_link_alt_22 ?>" rel="noopener noreferrer">
          ...
          <div class="col-xl-6 col-lg-6 col-md-12 z-2">
            <img src="<?php echo SITE_URL; ?>/img/<?php echo $produto->section_5_img_23 ?>"
              alt="<?php echo $produto->section_5_image_alt_23 ?>" class="w-100">
          </div>
    ...
    <?php
        function substituirConteudo($correspondencia)
        {
            global $cta;
            $valor_sem_chaves = $correspondencia[1];
            $valor_numerico_float = floatval($valor_sem_chaves);
            $id = intval($valor_sem_chaves);
            foreach ($cta as $ct) {
                if ($ct->id == $id) {
                    return $ct->cta;
                }
        ...
        $conteudo = $produto->section_6_textarea_24;
        $padrao = '/<[^>]*>\{([^}]*)\}<\/[^>]*>/';
        $conteudo_modificado = preg_replace_callback($padrao, 'substituirConteudo', $conteudo);
    ?>
    <section class="position-relative pt-5 pb-5">
      <div class="container">
        <div class="texto_corrido">
           <?php echo $conteudo_modificado ?>
        </div>
      </div>
    </section>
  </div>
