(function ($) {
  ...
  /*   let swiperAvaliacoes = new Swiper(".swiper-avaliacoes", {
      slidesPerView: 1,
      spaceBetween: 60,
      loop: true,
    }); */
    if ($(".swiper_home_six").length) {
  var projectsSwiper = new Swiper('.swiper_home_six', {
    slidesPerView: 1,
    effect: 'slide',
    centeredSlides: true,
    loop: true,
    ...
    document.querySelector('.button_home_next2').addEventListener('click', function () {
    projectsSwiper.slideNext();
  });

  document.querySelector('.button_home_prev2').addEventListener('click', function () {
    projectsSwiper.slidePrev();
  });
    }

  var about = new Swiper('.swiper_about_four', {
  effect: 'slide',
  centeredSlides: true,
  loop: true,
  spaceBetween: 60,
  ...
  breakpoints: {
   ...
   if ($(".swiper-container.two").length) {
  var swiperhome = new Swiper('.swiper-container.two', {
  ...
  document.querySelector('.button_home_next1').addEventListener('click', function () {
    swiperhome.slideNext();
  });

  document.querySelector('.button_home_prev1').addEventListener('click', function () {
