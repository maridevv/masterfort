                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                            <label  class="col-form-label">Favicon Vermelho</label>
                                            <input class="form-control" type="file" name="favicon_lp"/>
                                            </div> 
                                            <div class="col-md-6 col-sm-12" style="background: #669ab3;">
                                        <?php if(isset($editaConfig->favicon_lp) && !empty($editaConfig->favicon_lp)){?>
                                            <label  class="col-form-label">&nbsp;</label>
                                            <img src="../img/<?php echo $editaConfig->favicon_lp;?>" width="100" alt="">
                                            <?php }?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                            <label  class="col-form-label">Logo Branca</label>
                                            <input class="form-control" type="file" name="logo_branca"/>
                                            </div> 
                                            <div class="col-md-6 col-sm-12" style="background: #669ab3;">
                                        <?php if(isset($editaConfig->logo_branca) && !empty($editaConfig->logo_branca)){?>
                                            <label  class="col-form-label">&nbsp;</label>
                                            <img src="../img/<?php echo $editaConfig->logo_branca;?>" width="100" alt="">
                                            <?php }?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                            <label  class="col-form-label">Logo Verde</label>
                                            <input class="form-control" type="file" name="logo_verde"/>
                                            </div> 
                                            <div class="col-md-6 col-sm-12" style="background: #669ab3;">
                                        <?php if(isset($editaConfig->logo_verde) && !empty($editaConfig->logo_verde)){?>
                                            <label  class="col-form-label">&nbsp;</label>
                                            <img src="../img/<?php echo $editaConfig->logo_verde;?>" width="100" alt="">
                                            <?php }?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
	                                ...
	                                <input type="hidden" name="logo_branca_Atual" value="<?php echo $editaConfig->logo_branca;?>">
	                                ...
	                                <input type="hidden" name="favicon_lp_Atual" value="<?php echo $editaConfig->favicon_lp;?>">
	                                <input type="hidden" name="logo_verde_Atual" value="<?php echo $editaConfig->logo_verde;?>">
                                </form>
                            </div>
                        </div>
                    </div>
