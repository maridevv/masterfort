                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-sm-12">
                                                <label class="col-form-label">Imagem (49x40px)</label>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <label class="col-form-label">Imagem (118x21px)</label>
                                                <input class="form-control" type="file" name="section_1_img_3" />
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <label class="col-form-label">legenda</label>
                                                <input class="form-control" type="text" name="section_1_image_alt_3" />
                                            </div>
                                            <div class="col-md-12 col-sm-12">
                                                <label class="col-form-label">Breve</label>
                                                <textarea name="section_1_textarea_4" class="ckeditor" id="ckeditor"
                            ...
                            <input type="hidden" name="acao" value="addFaqs">
                            </form>
                        </div>
                    </div>
                </div>
