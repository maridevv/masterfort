...
if($pagina_individual == 'S') {
  echo "  <script>
          ...
          window.location='editar-contato.php?pi=S&id=$id';
      </script>";
  exit;
} else {
  echo "  <script>
