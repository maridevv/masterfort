...
<?php include 'header.php'; ?>
    <style>
  .image_single_home {
      background-image: url(<?php echo SITE_URL . '/img/' . $sucesso->section_1_img_3 ?>);
  ...
  @media (max-width:600px) {
      .image_single_home {
          background-image: url(<?php echo SITE_URL . '/img/' . $sucesso->section_1_img_4 ?>);
          background-position-y: center;
          background-size: cover;
      }
  }
...
<body>         <section class="page-banner bg_cover p-r  text-white">         <div class="container">             <?php echo $sucesso->section_1_conteudo_1 ?>             <br>             <?php echo $sucesso->section_1_conteudo_2 ?>         </div>     </section> </body>