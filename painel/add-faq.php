                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <!--                   <option value="PF" >Planos - Pessoa Física</option>-->
                                    <!--                   <option value="PJ">Planos - Empresas</option>-->
                                    <!--                   <option value="C">Coberturas</option>-->
                                    <!--                   <option value="I">Indique e Ganhe</option>-->
